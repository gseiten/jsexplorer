                    ...
                    <template v-slot="props">
                        <article class="media">
                            ...
                            <div class="media-content">
                                <div class="content">
                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellat cumque et voluptates tempore quam libero nisi iste minima! Obcaecati eos rerum quis, velit nemo veniam.</p>
                                </div>
                                    ...
                                    <div class="level-left">
                                        <div class="level-item is-size-7">
                                            <p>
                                                ...
                                                >{{props.row.full_name}}</span> 10 Hours ago
                                            </p>
                                        </div>
                                    </div>
