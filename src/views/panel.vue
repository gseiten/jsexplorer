                ...
                <nav class="level has-background-black-ter console_level">
                    ...
                    <div class="level-right">
                        ...
                        <div class="level-item" v-if="!isAnalysisOn">
                            <div
                                class="button is-dark is-small has-background-black-ter is-paddingless"
                            >
                                <b-tooltip
...
export default {
    ...
    methods: {
        ...
        paneAdded() {
            this.editorPanelSize = this.outputPanelSize = this.analysisPanelSize =
                100 / 3;
        },
